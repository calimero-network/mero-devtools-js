...
## `generateClient(manifest, clientName?, importPath?, options?)`
...
interface CodegenOptions {
  // Emit branded types + constructors for newtypes over a string or numeric
  // primitive. Default: true.
...
## `generateTypes(manifest, options?)`
