/* WASM Dev Tools Docs — Shared Navigation + Full-text Search */
(function () {
  'use strict';

  const REPO = 'https://github.com/calimero-network/mero-devtools-js';
  const PAGES_BASE = './';
  ...
  const NAV = [
    ...
    { section: 'Reference' },
    { label: 'CLI Reference', href: 'cli.html',          dot: '#58a6ff' },
    { label: 'API Reference', href: 'api-reference.html',dot: '#f778ba' },
    { label: 'ABI Format',    href: 'abi-format.html',   dot: '#39d0d8' },
  ];
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>ABI Codegen</em></strong>
            <span>WASM Dev Tools</span>
          </div>
        </div>
      </div>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network/mero-devtools-js" target="_blank" rel="noopener">
